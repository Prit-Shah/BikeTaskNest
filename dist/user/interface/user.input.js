...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_transformer_1.Transform)(({ value }) => value === null || value === void 0 ? void 0 : value.trim()),
    (0, class_validator_1.Matches)('^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{8,20}$', '', {
        message: 'Password Must contain Each of the Upper case,Lower case,Special Char and a Number',
    }),
    __metadata("design:type", String)
...
], UserInputType.prototype, "photo", void 0);
